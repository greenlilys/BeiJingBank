<template>
	<div>
		<div class="bibox">
			<div class="contant">
				<div class="clear">
					<div class="fl"><img src="../assets/images/contant2.png" alt="" /></div>
					<div class="fl textbox">
						<h1> 公司</h1>
						<p>河南牛电网络科技有限公司</p>
						<h1 style="margin-top:20px;">地址</h1>
						<p>河南省郑州市航海路与豫英路交叉口正商国际广场B座1606</p>
					</div>
				</div>	
			</div>
		</div>
...
<style scoped>
	.bibox{width:100%;background:url('../assets/images/contant1.jpg') no-repeat;background-size:cover;height:645px;}
	.contant{width:1200px;margin:0 auto;box-sizing: border-box;padding:40px 0 0 76px;color:#000;}
	.contant h1{font-size:40px;line-height:60px;}
